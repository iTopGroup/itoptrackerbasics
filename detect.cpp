...
Detection::Detection(Mat& in, CascadeClassifier& model, double scale)
{
    Detection::img = in;
    Detection::cascade = model;
    Detection::scale = scale;
            colors[0] = cv::Scalar(255,0,0);
            colors[0] = cv::Scalar(255,128,0);
            colors[0] = cv::Scalar(255,255,0);
            colors[0] = cv::Scalar(0,255,0);
            colors[0] = cv::Scalar(0,128,255);
            colors[0] = cv::Scalar(0,255,255);
            colors[0] = cv::Scalar(0,0,255);
            colors[0] = cv::Scalar(255,0,255);
}

bool Detection::render()
{
    double t = 0;
    Mat gray, smallImg;
